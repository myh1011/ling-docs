...
- 以下内容假设你对Linux系统有一定的了解，如果觉得难以理解，请使用Windows系统部署[Windows部署指南](/manual/deployment/win)
...
这可以 **一步到位** 安装完环境，你可以跳转到[配置 env](/manual/deployment/linux#env_file)继续，或者自己创建环境安装依赖。
